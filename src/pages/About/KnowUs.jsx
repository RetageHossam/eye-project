...
export default function KnowUs() {
 ...
 فريقنا
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {avatar.map((item)=>{
return <div className="group bg-[#161616] rounded-2xl p-6 text-center border border-[#262626] hover:border-orange-500/30 transition-all duration-300">
              ...
              <h3 className="font-bold text-white text-lg"> {item.author.name}</h3>
